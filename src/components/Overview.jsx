  ...
  return (
    <div className="w-full h-auto">
      <div className="h-auto w-full bg-transparent">
        ...
        <article className="text-normal text-slate-200 text-balance mt-4">{sdlcData.aboutUs.commitment}</article>
        <div className="w-full">
          {sdlcData.customerReviews.map((element,index)=>(
            <div className="w-auto flex flex-row items-center pt-2 pb-1 shadow hover:shadow-teal-300" key={index}>
                <div className="h-auto p-2 w-auto"> <FaUserCircle className="h-32 w-auto bg-transparent text-teal-400/40 hover:text-teal-300"/></div>
